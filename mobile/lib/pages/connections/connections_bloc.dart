...
const _kInitialConnectionsState =
    ConnectionsState(isLoading: true, error: null, connectionItems: []);
...
class ConnectionsBloc implements BaseBloc {
  ...
  factory ConnectionsBloc({
    ...
    /// Streams
    ///
    final connectionsState$ = _getConnections(userBloc, userId, userRepository)
  ...
  static Stream<ConnectionsState> _toState(LoginState loginState, String userId,
  ...
  static Stream<ConnectionsState> _getConnections(UserBloc userBloc,
      String userId, FirestoreUserRepository userRepository) {
    return userBloc.loginState$.switchMap((loginState) {
      return _toState(loginState, userId, userRepository);
    });
  }
}
