...
class SharedPrefUtil {
  static const _kSelectedLanguageCode = "com.treeapp.selected_language_code";
  static const _kEnglishCode = "en";

  final _selectedLanguageCodeController = BehaviorSubject<String>();

  SharedPrefUtil._() {
    SharedPreferences.getInstance().then((preferences) => _loadSelectedLanguageCode(preferences));
  }
  ...
  ValueStream<String> get selectedLanguageCode$ => _selectedLanguageCodeController.stream;
